...
var ImageCropper = (function (_super) {
    ...
    ImageCropper.prototype.setImage = function (img) {
        ...
        var tlPos = pointPool_1.PointPool.instance.borrow(cX - cropBounds.width / 2, cY + cropBounds.height / 2);
        var trPos = pointPool_1.PointPool.instance.borrow(cX + cropBounds.width / 2, cY + cropBounds.height / 2);
        var blPos = pointPool_1.PointPool.instance.borrow(cX - cropBounds.width / 2, cY - cropBounds.height / 2);
        var brPos = pointPool_1.PointPool.instance.borrow(cX + cropBounds.width / 2, cY - cropBounds.height / 2);
